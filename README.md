...
| ------------------------ | ---------------- | ------------------------ | -------------------------------------------------------------------- |
| **カレンダー機能**       | [K24072 更谷幸之助] | [GitHubアカウントを記入] | カレンダー表示、予定の視覚化、日付選択機能 (`front_end/calender.py`) |
| **予定管理機能**         | [K24111 中山隼] | [GitHubアカウントを記入] | 予定の追加・編集・削除機能 (`front_end/change.py`)                   |
| **給料計算機能**         | [K24066 西條暖生] | [GitHubアカウントを記入] | バイトシフトの集計・給料計算 (`front_end/money.py`)                  |
| **データ共有機能**       | [K24111 中山隼] | [GitHubアカウントを記入] | エクスポート・インポート、スケジュール共有 (`export/`, `utils/data_io.py`) |
| **出発時間管理** | [K24111 中山隼] | [GitHubアカウントを記入] | 移動時間計算、ユーザー設定管理 (`front_end/settings.py`)             |
| **バックエンド**         | [X24099 山中秀太] | [GitHubアカウントを記入] | データベース操作、API実装 (`back_end/functions.py`)                  |
